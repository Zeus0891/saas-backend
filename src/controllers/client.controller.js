...
const createClient = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const client = yield clientService.createClient(req.body);
...
const getClients = (_req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getClientById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const client = yield clientService.getClientById(Number(req.params.id));
        if (!client) {
...
const updateClient = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const client = yield clientService.updateClient(Number(req.params.id), req.body);
        res.json(client);
    }
    catch (error) {
        next(error);
...
const deleteClient = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield clientService.deleteClient(Number(req.params.id));
        res.status(204).send();
    }
    catch (error) {
        next(error);
